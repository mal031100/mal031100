...
<body>
	...
	<h3 align="center">Danh sách các trọng tài</h3>
	<p align="center"><u><a href="addTrongtai">Thêm mới</a></u>
	...
	<div class="container">
		<table align="center" >
			...
			<?php foreach ($info as $value): ?>
				<tr>
				<td><?= $STT++ ?></td>
				<td><?= $value['tentrongtai'] ?></td>
				<td><a href="suaTrongtai/<?= $value['id'] ?>">Sửa</a></td>
				<td><a href="deleteTrongtai/<?= $value['id'] ?>">Xóa</a></td>
		...
		$(document).ready(function() {
			$('.delete').click(function() {
				if (confirm('Bạn chắc chắn muốn xóa người này')) {
					window.location.href = "<?= base_url() ?>login/deleteTrongtai/<?= $value['id'] ?>";
				}
			});
		});
	</script> -->
