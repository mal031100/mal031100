...
<body>
	...
	<!-- <div class="container">
		...
		<div class="row">
			...
			<div class="col-md-4">
				<u><a href="doibong">Return</a></u>
				<form action="addCauthu" method="post">
				<table >
					<tr>
						<td>Tên Đội bóng:</td>
						<td><input type="text" placeholder="Nhập tên Đội bóng" name="tencauthu" class="form-control" required></td>
					</tr>
					<tr>
						<td>Ma so doi:</td>
						<td><input type="text" placeholder="Nhập số thành viên" name="madoi" class="form-control" required></td>
					</tr>
					<tr>
						<td></td>
