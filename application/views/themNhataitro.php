...
<head>
	<meta charset="UTF-8">
	<title>Thêm mới Nhà tài trợ</title>
	<style>
		tr, th, td {
...
<body>
	...
	<!-- <div class="container">
		...
		<h2>Thêm mới Nhà tài trợ</h2>
		<div class="row">
			<div class="col-md-4"></div>
			<div class="col-md-4">
				<u><a href="nhataitro">Return</a></u>
				<form action="addNhataitro" method="post">
				<table >
					<tr>
						<td>Tên Nhà tài trợ:</td>
						<td><input type="text" placeholder="Nhập tên Nhà tài trợ" name="tennhataitro" class="form-control" required></td>
					</tr>
					<tr>
						<td>Thông tin:</td>
						<td><input type="text" placeholder="Nhập Thông tin" name="thongtin" class="3form-control" required></td>
					</tr>
					<tr>
						<td></td>
