...
<body>
	...
	<!-- <div class="container">
		...
		<h2>Thêm mới Lịch đấu</h2>
		<div class="row">
			<div class="col-md-4"></div>
			<div class="col-md-4">
				<u><a href="lichthidau">Return</a></u>
				<form action="addLichthidau" method="post">
				<table >
					<tr>
						<td>Tên đội A:</td>
						<td><input type="text" placeholder="Nhập tên đội A" name="doiA" class="form-control" required></td>
					</tr>
					<tr>
						<td>Ngày thi đấu:</td>
					...
					<tr>
						<td>Tên đội B:</td>
						<td><input type="text" placeholder="Nhập tên đội B" name="doiB" class="form-control" required></td>
					</tr>
					<tr>
						<td></td>
