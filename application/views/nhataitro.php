...
<body>
	...
	<h3 align="center">Danh sách các nhà tài trợ</h3>
	<p align="center"><u><a href="addNhataitro">Thêm mới</a></u>
	...
	<div class="container">
		<table align="center" >
			...
			<?php foreach ($info as $value): ?>
				<tr>
				<td><?= $STT++ ?></td>
				<td><?= $value['tennhataitro'] ?></td>
				<td><?= $value['thongtin'] ?></td>
				<td><a href="suaNhataitro/<?= $value['id'] ?>">Sửa</a></td>
				<td><a href="deleteNhataitro/<?= $value['id'] ?>">Xóa</a></td>
		...
		$(document).ready(function() {
			$('.delete').click(function() {
				if (confirm('Bạn chắc chắn muốn xóa người này')) {
					window.location.href = "<?= base_url() ?>login/deleteNhataitro/<?= $value['id'] ?>";
				}
			});
		});
	</script> -->
