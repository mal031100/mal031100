...
<head>
	<meta charset="UTF-8">
	<title>Sửa thông tin Trọng tài</title>
	<style>
		tr, th, td {
...
<body>
	...
	<!-- <div class="container">
		...
		<h2>Sửa thông tin Trọng tài</h2>
		<div class="row">
			<div class="col-md-4"></div>
			<div class="col-md-4">
				<u><a href="<?= base_url()?>login/trongtai">Return</a></u>
				<?php foreach ($info as $value): ?>
				<form action="<?= base_url()?>login/updateTrongtai" method="post">
				<table >
					<tr>
					...
					<tr>
						<td>Tên trọng tài:</td>
						<td><input type="text" placeholder="<?= $value['tentrongtai'] ?>" name="tentrongtai" class="form-control" required></td>
					</tr>
					<tr>
						<td></td>
