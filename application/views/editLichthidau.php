...
<head>
	<meta charset="UTF-8">
	<title>Cập nhật thông tin Lịch thi đấu</title>
	<style>
		tr, th, td {
...
<body>
	...
	<!-- <div class="container">
		...
		<h2>Cập nhật thông tin Lịch thi đấu</h2>
		<div class="row">
			<div class="col-md-4"></div>
			<div class="col-md-4">
				<u><a href="<?= base_url()?>login/lichthidau">Return</a></u>
				<?php foreach ($info as $value): ?>
				<form action="<?= base_url()?>login/updateLichthidau" method="post">
				<table >
					<tr>
					...
					<tr>
						<td>Tên đội A:</td>
						<td><input type="text" placeholder="<?= $value['doiA'] ?>" name="doiA" class="form-control" required></td>
					</tr>
					<tr>
						<td>Ngày thi đấu:</td>
						<td><input type="date" name="ngaythidau" class="form-control" required></td>
					</tr>
					<tr>
						<td>Tên đội B:</td>
						<td><input type="text" placeholder="<?= $value['doiB'] ?>" name="doiB" class="form-control" required></td>
					</tr>
					<tr>
						<td></td>
